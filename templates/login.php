    ...
    <div class="wrapper-page">
            <div class="panel panel-color panel-success panel-pages">
                <div class="panel-heading bg-color"> 
                    <img class="profile-img" src="images/logo1.png" alt="">
                    <h3 class="text-center m-t-15 text-white">LOGIN</h3>
                </div> 
...
?>
      <form class="form-horizontal m-t-20" id="form-login" action="proseslogin.php" method="POST">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-success btn-lg w-lg waves-effect" type="submit">Log In</button>
                        </div>
                    </div>
