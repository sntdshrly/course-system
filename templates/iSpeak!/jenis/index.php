...
echo "<div class='panel panel-border panel-success'>
                                    <div class='panel-heading'> 
                                        <h3 class='panel-title'><i class='fa fa-list'></i> Data Mata Pelajaran</h3> 
                                    </div>  <div class='panel-body'> 
									<p align='right'><a class='btn btn-success' href='?p=jenis&aksi=tambah'><i class='icon-plus'></i>Tambah Mata Pelajaran</a></p>
                                   <hr>
                                <table id='datatable' class='table table-hover'>
                                    <thead>
                                        <tr>
                                            <th><i class='icon-time'></i> Mata Pelajaran</th>
                                            <th><i class='icon-signal'></i> Harga/Jam</th>
...
echo "<div class='panel panel-border panel-success'>
                                    <div class='panel-heading'> 
                                        <h3 class='panel-title'><i class='fa fa-list'></i> Edit Jenis Mata Pelajaran</h3> 
                                    </div>  <div class='panel-body'> 
			...
			<input type='submit' class='btn btn-success' value='Update'> <a class='btn btn-danger' href='?p=harga'>Batal</a>
		  </form>
		</div> 
...
echo '<div class="panel panel-border panel-success">
					 ...
					 <div class="control-group">
					   <div class="form-group">
                            <label>Jenis</label>
                            <div class="span9"><input class="form-control" placeholder="Masukan Mata Pelajaran"  type="text" name="jenis" /></div>
                        </div>						
					   <div class="form-group">
                            <label>Harga/Kg</label>
                            <div class="span9"><input class="form-control" size="16" type="number" placeholder="Masukan Harga" name="harga" /></div>
                        </div>				 
					<Br>

			<input type="submit" class="btn btn-success" value="Tambah"> <a class="btn btn-danger" href="?p=jenis">Batal</a>
		  </form>
		  <br>
