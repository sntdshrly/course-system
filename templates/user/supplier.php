...
echo "<div class='panel panel-border panel-success'>
                                    <div class='panel-heading'> 
                                        <h3 class='panel-title'><i class='fa fa-list'></i> Olah Guru</h3> 
                             ...
                             echo"<tr>
							  <td>$i</td>
							    <td>$r[nama]</td>
                                    <td>$r[alamat]</td>
									<td>$r[telp]</td>
                                    <td><a class='btn btn-success' href='?p=olahs&aksi=edit&id=$r[id]'><i class='icon-edit'></i>Edit</a>
...
echo "<div class='panel panel-border panel-primary'>
                                    <div class='panel-heading'> 
                 <h3 class='panel-title'><i class='fa fa-list'></i> Edit Guru</h3> 
                                    </div>  <div class='panel-body'> 
