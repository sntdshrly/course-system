<div class='panel panel-border panel-success'>
                                    <div class='panel-heading'> 
                                        <h3 class='panel-title'><i class='fa fa-list'></i> Data Pembelian Mata Kuliah</h3> 
                                    </div>  <div class='panel-body'> 
                                <table id='datatable' class='table table-hover'>
                                    <thead>
                                        <tr>
										<th><i class='icon-terminal'></i> No</th>
                                            <th><i class='icon-terminal'></i> Nama Mata Pelajaran</th>
                                            <th><i class='icon-time'></i> Jumlah/ Jam</th>
											<th><i class='icon-signal'></i> Total Harga</th>
											<th><i class='icon-signal'></i> Guru</th>
