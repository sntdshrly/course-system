...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="images/brain.png">

        <title>iSpeak! Language Centre</title>
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><span>ISPEAK!</span></a>
                    </div>
                </div>
...
<li>
                            ...
                            <?php if ($hasil['level']!=='Konsumen') { ?>
														<li>
                                <a href="?p=tambahko" class="waves-effect"><i class="fa fa-user-plus"></i><span> Tambah Siswa </span></a>
                            </li>
							       <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-list"></i> <span> Data </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="?p=barang">Jadwal</a></li>
                                    <li><a href="?p=datako">Siswa</a></li>
									 <li><a href="?p=datas">Guru</a></li>
									  <li><a href="?p=datak">Admin</a></li>
									  <li><a href="?p=jenis">Mata Pelajaran</a></li>
							...
							<?php if ($hasil['level']=='Administrator') { ?>
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="?p=tambahk">Tambah Admin</a></li>
									 <li><a href="?p=tambahs">Tambah Guru</a></li>
									 <li><a href="?p=olahk">Olah Admin</a></li>
									 <li><a href="?p=olahs">Olah Guru</a></li>
                                </ul>
                            </li>
<?php } ?>
<?php } ?>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">iSpeak!</h4>
